...
bool downloadFile(const std::string& url, const std::string& toDestination, tsl::elm::ListItem* listItem, int totalCommands, int curProgress)
{
...
bool unzipFile(const std::string& zipFilePath, const std::string& toDestination, tsl::elm::ListItem* listItem, int totalCommands, int curProgress)
{
