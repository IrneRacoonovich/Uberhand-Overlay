...
std::vector<std::pair<std::string, std::vector<std::vector<std::string>>>> loadOptionsFromIni(const std::string& configIniPath, bool makeConfig)
{
...
std::vector<std::vector<int>> parseIntIniData(std::string input, bool skipFirstItem)
{
