...
bool mirrorDeleteFiles(const std::string& sourcePath, const std::string& targetPath)
{
...
bool mirrorCopyFiles(const std::string& sourcePath, const std::string& targetPath)
{
    std::vector<std::string> fileList = getFilesListFromDirectory(sourcePath);
    bool result = true;
